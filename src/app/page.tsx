...
import { Sparkles, Calendar, File, Download } from "lucide-react";

const categories = [
  {
    title: "Graphic Design",
    img: "/comp-covers/Graphic design web.png", 
    details: "/tracks/graphic-design",
    register: "/register?track=graphic-design",
  },
  {
    title: "Web Development",
    img: "/comp-covers/programming web.png",
    details: "/tracks/web-development",
    register: "/register?track=web-development",
  },
  {
    title: "Video Editing",
    img: "/comp-covers/Video Editing web.png",
    details: "/tracks/video-editing",
    register: "/register?track=video-editing",
  },
  {
    title: "Gaming",
    img: "/comp-covers/gaming web.png",
    details: "/tracks/gaming",
    register: "/register?track=gaming",
  },
  {
    title: "Quiz",
    img: "/comp-covers/web quiz.png",
    details: "/tracks/quiz",
    register: "/register?track=quiz",
  },
];
    ...
    <>
      ...
      <main id="home" className="relative min-h-screen overflow-hidden">
        <Image
          ...
          priority
          sizes="100vw"
          className="z-0 object-cover object-[50%_68%] brightness-[.72] contrast-[1.05]"
        />
        <div className="absolute inset-0 z-10 bg-gradient-to-b from-black/65 via-black/50 to-[#160e0e]/75" />
        ...
        <div className="relative z-20 mx-auto max-w-7xl px-6 py-20">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div className="text-left">
              ...
              />
              <p className="mt-4 text-[15px] tracking-[.18em] uppercase text-white/80">
              ...
              <div className="mt-8 flex flex-wrap items-center gap-4">
                {true ? (
                  <button
                    className="rounded-full px-7 py-3 text-base font-semibold text-black
                         bg-gradient-to-r from-[#FDB44B] via-[#FF8A3D] to-[#E65F4E]
                         shadow-[0_10px_40px_rgba(230,95,78,0.45)]
                         hover:shadow-[0_14px_60px_rgba(230,95,78,0.6)]
                         hover:scale-[1.02] active:scale-[.99] transition"
                  >
                    Register Now
                  </button>
                ) : (
                  <button
                    ...
                    className="rounded-full px-7 py-3 text-base font-semibold
                         text-white/65 border border-white/20 bg-white/10 backdrop-blur
                         cursor-not-allowed"
                  >
                ...
                <a
                  href="#timeline"
                  className="rounded-full px-7 py-3 text-base font-semibold text-white/90
    ...
    <div className="mt-10 grid gap-8 sm:grid-cols-2 md:grid-cols-3">
      {categories.map((c) => (
        <CategoryCard
          ...
          title={c.title}
          img={c.img}
          detailsHref={c.details}
          registerHref={c.register}
        />
      ))}
    </div>
  </div>
